...
class ContactPage extends StatelessWidget {
  final List contactItems = [
    ...
    ContactInfo(Icons.phone, 'Phone', '09519537603', Colors.green),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 20),
                    Text('Contact Info', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.black87)),
                    SizedBox(height: 10),
                    Text('Feel free to reach out to me through any of these contacts', style: TextStyle(fontSize: 16, color: Colors.grey[600]), textAlign: TextAlign.center),
                  ],
                ),
              ),
